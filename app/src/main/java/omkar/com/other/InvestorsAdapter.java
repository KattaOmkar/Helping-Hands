        ...
        if (lender.isAmount_refunded()) {
            ...
            refunded.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view11) {
                    if (lender.getUserId().equals(mAuth.getCurrentUser().getEmail()) && lender.isAmount_lent()) {
                        ...
                        if (!lender.isAmount_lent()) {
                            Toast.makeText(getContext(), "Amount is not lent", Toast.LENGTH_SHORT).show();
                        } else
                            Toast.makeText(getContext(), "Only For Investor", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        if (lender.isAmount_lent()) {
            ...
            received.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view1) {
                    if (mAuth.getCurrentUser().getEmail().equals(loanGroup.getBorrowerID())) {
                        Toast.makeText(getContext(), "CLICK", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(getContext(), "Only For Borrower", Toast.LENGTH_SHORT).show();
                    }
                }
            });
